...
**Status:** Phase 6C0 complete at `1dee6c1`. The complete local gate passes 120/120; full repository verification passes 1436/1436 plus every structural invariant. Independent specification and quality/security reviews both approve. Phase 6C1 remains gated on production MCP checkpoint binding and the real `mechanics-proof-party --run` path.
...
- [x] **Step 1: Write failing card-order tests**
...
- [x] **Step 3: Implement card bootstrap**
...
- [x] **Step 1: Write failing signer-boundary tests**
...
- [x] **Step 3: Add public-key inspection without changing CLI output**
...
- [x] **Step 4: Implement the bounded authority**
...
- [x] **Step 5: Run GREEN and unchanged helper tests**
...
- [x] **Step 1: Write extraction compatibility tests**
...
- [x] **Step 3: Extract, do not duplicate**
...
- [x] **Step 4: Run GREEN and full relevant suites**
...
- [x] **Step 3: Implement the bridge and ACP callback**
...
- [x] **Step 4: Run GREEN and direct-channel regressions**
...
- [x] **Step 4: Mark Phase 6C0 complete**
