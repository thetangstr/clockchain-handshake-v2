...
export const ACP_PROCESS_TRANSPORT_FAILURE_STAGES = Object.freeze([
  ...
  "completion-protocol-retained-execute-execution-command-mismatch",
  "completion-protocol-retained-execute-execution-action-expired",
  "completion-protocol-retained-execute-execution-action-replayed",
  "completion-protocol-retained-execute-execution-helper-launch",
  "completion-protocol-retained-execute-execution-helper-failed",
  "completion-protocol-retained-execute-execution-output-invalid",
  "completion-protocol-retained-execute-execution-completion-failed",
