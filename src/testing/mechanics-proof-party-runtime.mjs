...
const RUNTIME_FAILURE_STAGES = Object.freeze([
  ...
  "agent-launch-completion-permission-session", "agent-launch-completion-permission-command",
  ...
  "agent-launch-completion-permission-unknown", "agent-launch-completion-stop", "evidence-validate",
