...
test("standalone packages import and run from installed tarballs without repo-relative paths", async () => {
  ...
  try {
    ...
    assert.equal(sdkManifest.dependencies["@clockchain/handshake-protocol"], "0.3.2");
    assert.equal(cliManifest.dependencies["@clockchain/handshake-sdk"], "0.3.2");
    assert.equal(cliManifest.dependencies["@clockchain/handshake-protocol"], "0.3.2");
  } finally {
